...
GCC_URL=http://ftpmirror.gnu.org/gcc/gcc-12.1.0/gcc-12.1.0.tar.xz
...
GNUPRUMCU_URL=https://github.com/dinuxbg/gnuprumcu/releases/download/v0.9.0/gnuprumcu-0.9.0.tar.gz
